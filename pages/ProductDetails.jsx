...
const ProductDetails = () => {
  ...
  const {imgUrl, productName, price, description, category,shortDesc } = product;
            ...
            <Row>
              ...
              <Col lg='6'>
                <div className="product__details">
                  ...
                  <motion.button whileTap={{scale:1.2}} className="buy__btn" >View in 3Dmodel</motion.button>
